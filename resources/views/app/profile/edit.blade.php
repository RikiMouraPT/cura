    ...
    <form class="bg-white rounded-xl shadow-md p-8 space-y-8">
        ...
        <section>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select class="w-full px-4 py-3 border border-teal-200 rounded-xl focus:ring-2 focus:ring-teal-500">
        ...
        <section>
            ...
            <div class="mt-6">
                ...
                <textarea rows="3"
                          class="w-full px-4 py-3 border border-teal-200 rounded-xl focus:ring-2 focus:ring-teal-500 resize-none">Rua das Flores, 123, 4º Andar
